...
namespace EMP.UAHelper.Core.Services
{
    ...
    public class LocalizationService
    {
        ...
        private static readonly Dictionary<string, string> UA = new()
        {
            ...
            ["settings.dc.col_name"] = "Назва",
            ["settings.dc.col_url"] = "URL вебхука",
            ["settings.dc.reveal_channel"] = "Показати/приховати URL цього каналу",
        ...
        private static readonly Dictionary<string, string> EN = new()
        {
            ...
            ["settings.dc.col_name"] = "Name",
            ["settings.dc.col_url"] = "Webhook URL",
            ["settings.dc.reveal_channel"] = "Show/hide this channel's URL",
